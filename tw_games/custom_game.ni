...
The attic part 0 is some text that varies. The attic part 0 is "You find yourself in an attic. A normal kind of place.
 ...
 You scan the room for a counter, and you find a counter. [if there is something on the s_0]On the counter you can make out [a list of things on the s_0].[end if]".
The attic part 1 is some text that varies. The attic part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of garbage.[end if]".
The attic part 2 is some text that varies. The attic part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The attic part 3 is some text that varies. The attic part 3 is " gate leading west. There is an exit to the south. Don't worry, it is unblocked.".
The description of r_3 is "[attic part 0][attic part 1][attic part 2][attic part 3]".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just shown up in a scullery. You begin to take stock of what's here.

 Hey, want to see a rack? Look over there, a rack. The rack is ordinary.[if there is something on the s_1] On the rack you can make out [a list of things on the s_1].[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it.[end if]".
The scullery part 2 is some text that varies. The scullery part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is " gate leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just sauntered into a pantry. Okay, just remember what you're here to do, and everything will go great.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've entered a bedchamber.
 ...
 As if things weren't amazing enough already, you can even see a type 1 safe.[if c_0 is open and there is something in the c_0] The type 1 safe contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
...
The bedchamber part 3 is some text that varies. The bedchamber part 3 is " door leading north. You need an unguarded exit? You should try going south.".
...
The vault part 0 is some text that varies. The vault part 0 is "Well, here we are in a vault. Okay, just remember what you're here to do, and everything will go great.

 Look out! It's a- oh, never mind, it's just a table. The table is standard.[if there is something on the s_2] On the table you can see [a list of things on the s_2]. Classic TextWorld.[end if]".
The vault part 1 is some text that varies. The vault part 1 is "[if there is nothing on the s_2] But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The d_0 is locked.
The description of c_0 is "The type 1 safe looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_0 is "type 1 safe".
Understand "type 1 safe" as c_0.
Understand "type" as c_0.
Understand "1" as c_0.
Understand "safe" as c_0.
The c_0 is in r_1.
The c_0 is closed.
The description of k_1 is "The type 1 keycard is surprisingly heavy.".
...
The description of o_0 is "The top hat is well-used.".
...
The description of o_2 is "The ladle appears to fit in here".
...
The description of o_1 is "The shadfly is antiquated.".
...
Test quest0_0 with "unlock gate with keycard / open gate / go east / take cookie from counter / eat cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First off, if it's not too much trouble, I need you to check that the".
The objective part 1 is some text that varies. The objective part 1 is " gate inside the scullery is unlocked with the keycard. And then, open the gate within the scullery. And then, go east. Then, take the cookie from the counter. Then, eat the cookie. That's it!".
